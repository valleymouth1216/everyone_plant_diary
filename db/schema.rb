...
ActiveRecord::Schema.define(version: 2022_09_03_063435) do
  ...
  create_table "diary_tag_relations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["diary_book_id"], name: "index_diary_tag_relations_on_diary_book_id"
  ...
  add_foreign_key "diary_tag_relations", "diary_books"
